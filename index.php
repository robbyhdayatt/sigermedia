                    ...
                    <div class="carousel-item <?= ($i==0)?'active':'' ?>" data-bs-interval="6000"> 
                        ...
                        <div class="carousel-caption text-start glass-caption">
                            ...
                            <h2 class="fw-bold text-white hero-title animate__animated animate__fadeInUp" style="line-height: 1.3;">
                                <a href="<?= $base_url ?>detail/<?= $sl['id'] ?>/<?= $sl['slug_berita'] ?>" class="text-white text-decoration-none hover-underline">
                                    <?= $sl['judul'] ?>
                                </a>
                            </h2>
                            ...
                            <a href="<?= $base_url ?>detail/<?= $sl['id'] ?>/<?= $sl['slug_berita'] ?>" class="btn btn-sm btn-outline-light rounded-pill px-4 animate__animated animate__fadeInUp">
                    ...
                    <div class="col-md-8">
                        <div class="card-body py-3 px-4 d-flex flex-column h-100 justify-content-center">
                            ...
                            <h5 class="card-title fw-bold mb-2">
                                <a href="<?= $base_url ?>detail/<?= $row['id'] ?>/<?= $row['slug_berita'] ?>" class="text-dark text-decoration-none hover-primary">
                                    <?= $row['judul'] ?>
                                </a>
                            </h5>
                            ...
                            <div class="mt-3">
                                <a href="<?= $base_url ?>detail/<?= $row['id'] ?>/<?= $row['slug_berita'] ?>" class="text-primary fw-bold text-decoration-none small">
